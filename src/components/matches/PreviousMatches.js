                                ...
                                <React.Fragment key={match.id}>
                                    <div className="results-headings mb-1 mt-1">
                                        <h3 className="results-date">
                                            Date:
                                            <span className="date-span">{formattedDate.toLocaleDateString()}</span>
                                        </h3>
                                        <h3 className="results-competition">{match.competition.name}</h3>
                                    </div>
                                    <ul className="results-list">
                                        <li className="results-list-item" style={{padding: "0.5rem"}}>
                                            <span className="results-list-item-home">{match.homeTeam.name}</span>
                                            ...
                                            <span className="results-list-item-away">{match.awayTeam.name}</span>
                                        </li>
                                    </ul>
                                </React.Fragment>
                            )
